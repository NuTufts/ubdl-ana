...
#SBATCH --output=plot_LEE_dev_sub1.txt
...
DLMERGED_LIST=/cluster/tufts/wongjiradlab/nutufts/dlgen2prod/maskrcnn_input_filelists/mcc9_v29e_dl_run3b_bnb_intrinsic_nue_overlay_nocrtremerge_MRCNN_INPUTS_LIST.txt
module load singularity

# CPU MODE
srun singularity exec ${container} bash -c "cd ${RUN_DLANA_DIR} && source run_batch_1e1p_plots.sh $OFFSET $STRIDE $SAMPLE_NAME ${INPUTFILE} 0 1 ${DLMERGED_LIST}"
