...
INPUTFILE=/cluster/tufts/wongjiradlab/twongj01/ubdl-ana/dev_1e1p_selection/tmp_intrinsic.txt
module load singularity

# CPU MODE
srun singularity exec ${container} bash -c "cd ${RUN_DLANA_DIR} && source run_batch_1e1p_plots.sh $OFFSET $STRIDE $SAMPLE_NAME ${INPUTFILE}"
