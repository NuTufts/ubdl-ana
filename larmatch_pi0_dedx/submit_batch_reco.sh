...
#SBATCH --output=larflow_reco_bnbnu.log
...
# CPU MODE
singularity exec --bind /cluster/tufts/wongjiradlabnu:/cluster/tufts/wongjiradlabnu,/cluster/tufts/wongjiradlab:/cluster/tufts/wongjiradlab ${container} bash -c "cd ${SCRIPTS_DIR} && source run_batch_larflowreco_mc_cpu.sh"
